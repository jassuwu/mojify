  ...
  release:
    ...
    steps:
      ...
      - name: Validate Homebrew formula
        ...
        run: |
          set -euo pipefail
          brew audit --formula homebrew-tap/Formula/mojify.rb
          brew install --build-from-source ./homebrew-tap/Formula/mojify.rb
          brew test ./homebrew-tap/Formula/mojify.rb
